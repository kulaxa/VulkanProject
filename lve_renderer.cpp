  ...
  if (lveSwapChain == nullptr) {
    ...
    VkCommandBuffer LveRenderer::beginFrame(){
       ...
       void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer){
           ...
           assert(commandBuffer == getCurrentCommandBuffer() &&"Can begin Swap chain render pass from a different frame");
         ...
         void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer){
                assert(isFrameStarted && "Can't call end Swap chain Render  pass if frame is not in progress");
           assert(commandBuffer == getCurrentCommandBuffer() &&"Can end Swap chain render pass from a different frame");
