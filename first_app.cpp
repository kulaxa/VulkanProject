...
namespace lve
{
    ...
    void FirstApp::run()
    {
       ...
       // GLFWwindow *window = glfwCreateWindow(1280, 720, "Dear ImGui GLFW+Vulkan example", NULL, NULL);
        ...
        g_MinImageCount = lveRenderer.getSwapChain() ->imageCount();
       ...
       // check_vk_result(err);
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
        {
         ...
         // wd->RenderPass = lveRenderer.getSwapChainRenderPass();
    ...
    //lve rendere.getSwapChainRenderPass baca segmentarion fault jebiga.
    ImGui_ImplVulkan_Init(&init_info, lveRenderer.getSwapChainRenderPass());

        /*  ImGui_ImplGlfw_InitForVulkan(lveWindow.getWindow(), true);
        ImGui_ImplVulkan_InitInfo init_info = {};
        init_info.Instance = lveDevice.getInstance();// g_Instance;
        init_info.PhysicalDevice = lveDevice.getPhysicalDevice();//g_PhysicalDevice;
        ...
        init_info.Subpass = 0;
        init_info.MinImageCount =g_MinImageCount ;
        init_info.ImageCount = lveRenderer.getSwapChain().get() ->imageCount();
        init_info.MSAASamples = VK_SAMPLE_COUNT_1_BIT;
        init_info.Allocator = g_Allocator;
        init_info.CheckVkResultFn = check_vk_result;
        ImGui_ImplVulkan_Init(&init_info, lveRenderer.getSwapChain().get()->getRenderPass());
        ...
        */
        ...
        // Upload Fonts
        {
            ...
            VkCommandBuffer command_buffer = lveRenderer.getCurrentCommandBuffer();//wd->Frames[wd->FrameIndex].CommandBuffer;
