...
namespace lve{
    ...
    void FirstApp::loadModels(){
     ...
     // makeCircle({{0.4f, -0.4f}}, 0.5f, 0.1, &vertices);
    //makeCircle({{0.75f, 0.75f}}, 0.2f, 0.1, &vertices);
      
       //FillVert({{0.0f, 0.0f}},0.5f, &vertices, 5);
        ...
        //frame = (frame+1) % 100;
         ...
         VkCommandBufferBeginInfo beginInfo{};
            ...
            lveModel ->bind(commandBuffers[imageIndex]);
                ...
                // push.offset ={-0.5f + frame*0.02f, -0.4f * 0.25f*j};
                
                 push.color = {frame* 0.01f, frame*0.05f,frame* 0.022f};
